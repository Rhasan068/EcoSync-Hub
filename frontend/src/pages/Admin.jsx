                                    ...
                                    {pendingProducts.map((p) => (
                                        <Grid item xs={12} lg={6} key={p.id}>
                                            <Card className="card hover-lift" sx={{ p: 0, overflow: 'hidden', display: 'flex' }}>
                                                <Box component="img" src={getImageUrl(p.image_url)} sx={{ width: 180, height: 180, objectFit: 'cover' }} />
                                    ...
                                    {approvedProducts.map((p) => (
                                        <Grid item xs={12} lg={6} key={p.id}>
                                            <Card className="card" sx={{ p: 0, overflow: 'hidden', display: 'flex', opacity: 0.9 }}>
                                                <Box component="img" src={getImageUrl(p.image_url)} sx={{ width: 140, height: 140, objectFit: 'cover' }} />
                        ...
                        <CardContent>
                            ...
                            <form onSubmit={handleChallengeSubmit}>
                                <Grid container spacing={3}>
                                    <Grid item xs={12} sm={6}><TextField fullWidth label="Mission Title" value={challengeForm.title} onChange={(e) => setChallengeForm({ ...challengeForm, title: e.target.value })} required /></Grid>
                                    <Grid item xs={12} sm={6}><TextField fullWidth label="EP Reward" type="number" value={challengeForm.points_reward} onChange={(e) => setChallengeForm({ ...challengeForm, points_reward: e.target.value })} required /></Grid>
                                    <Grid item xs={12}><TextField fullWidth label="Description" multiline rows={3} value={challengeForm.description} onChange={(e) => setChallengeForm({ ...challengeForm, description: e.target.value })} required /></Grid>
                                    <Grid item xs={12} sm={4}><TextField fullWidth label="CO2 Goal (kg)" type="number" value={challengeForm.co2_saving_kg} onChange={(e) => setChallengeForm({ ...challengeForm, co2_saving_kg: e.target.value })} required /></Grid>
                                    <Grid item xs={12} sm={4}><TextField fullWidth label="Duration (days)" type="number" value={challengeForm.duration_days} onChange={(e) => setChallengeForm({ ...challengeForm, duration_days: e.target.value })} required /></Grid>
                                    ...
                                    <Grid item xs={12}>
                                        ...
                                        {challengeForm.image_url && <Box component="img" src={getImageUrl(challengeForm.image_url)} sx={{ mt: 2, width: 150, borderRadius: '12px', display: 'block' }} />}
                                    </Grid>
                                    <Grid item xs={12}><Button type="submit" variant="contained" size="large" sx={{ borderRadius: '12px', px: 4, fontWeight: 900 }}>Launch Mission</Button></Grid>
                                </Grid>
                            </form>
                        </CardContent>
                    </Card>
                ...
                <DialogContent>
                    <Box sx={{ pt: 2, display: 'flex', flexDirection: 'column', gap: 3 }}>
                        ...
                        <Box>
                            ...
                            {editForm.image_url && (
                                <Box component="img" src={getImageUrl(editForm.image_url)} sx={{ mt: 2, width: '100%', maxHeight: 200, objectFit: 'cover', borderRadius: '12px' }} />
                            )}
                        </Box>
                    </Box>
                </DialogContent>
