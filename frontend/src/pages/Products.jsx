                        ...
                        <Card className="card hover-lift" sx={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden', p: 0, borderRadius: '24px' }}>
                            <Box sx={{ position: 'relative', overflow: 'hidden' }}>
                                <CardMedia
                                    component="img"
                                    height="280"
                                    image={getImageUrl(product.image_url) || 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=600'}
                                    alt={product.name}
                                    sx={{ filter: 'brightness(0.98)', transition: 'transform 0.5s ease', '&:hover': { transform: 'scale(1.1)' } }}
                                />
